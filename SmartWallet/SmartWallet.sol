...
contract SmartWallet is Ownable {
    ...
    function approve(address spender, uint256 amount) public {
        require(
            msg.sender != spender,
            "SmartWallet: you don't need to approve yourself"
        );
        require(
            spender != address(0),
            "SmartWallet: can not approve the zero address"
        );
    ...
    function transferFrom(
        ...
        require(
            ...
            "SmartWallet: You cannot transfert for this account"
        );
        require(
            _allowances[from][msg.sender] >= amount,
            "SmartWallet: Amount is too high for your allocated funds"
        );
        require(
    ...
    function _withdraw(address recipient, uint256 amount) private {
        ...
        uint256 fees =
            _vipMembers[recipient] || recipient == owner()
                ? 0
                : _calculateFees(amount, _tax);
        /*
        uint256 fees = 0;
